...
public class MajorController {
    ...
    public ResponseEntity<ApiResponse<MasterDataResponse>> create(@Valid @RequestBody MasterDataRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.ok(majorService.create(request, userId)));
    }
    ...
    public ResponseEntity<ApiResponse<Page<MasterDataResponse>>> getAll(
        ...
        Page<MasterDataResponse> paged = majorService.getAll(PageRequest.of(page, size));
    ...
    public ResponseEntity<ApiResponse<MasterDataResponse>> getById(@PathVariable Long id) {
        return ResponseEntity.ok(ApiResponse.ok(majorService.getById(id)));
    }
    ...
    public ResponseEntity<ApiResponse<MasterDataResponse>> update(@PathVariable Long id,
        ...
        Long userId = SecurityContextHelper.getCurrentUserId();
        return ResponseEntity.ok(ApiResponse.ok(majorService.update(id, request, userId)));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable Long id) {
        Long userId = SecurityContextHelper.getCurrentUserId();
        majorService.delete(id, userId);
